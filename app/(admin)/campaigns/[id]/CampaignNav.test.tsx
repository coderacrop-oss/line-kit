...
describe('แถบซ้ายอยู่ในโครงของทุกจอในแคมเปญ', () => {
  ...
  it('เนื้อหาอยู่ข้างแถบ ไม่ใช่ใต้แถบ · และสูงเต็มจอลบทั้งแถบบนและแถบชื่อแคมเปญ', () => {
    expect(layout).toContain("display: 'flex'")
    // 56 คือแถบบนอย่างเดียว (ไม่มีชื่อแคมเปญให้วาด) · 88 คือ 56+32 ตอนมีแถบชื่อแคมเปญด้วย
    expect(layout).toMatch(/56/)
    expect(layout).toMatch(/88/)
  })
