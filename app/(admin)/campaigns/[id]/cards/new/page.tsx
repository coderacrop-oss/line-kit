        ...
        <Panel>
          <Panel.Row style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {/*
              ...
              *
              * บล็อกเอดิเตอร์ของ M3-S02 ยังไม่มีใครเขียน (Task 13) · การพาไปที่นั่น
              * คือหน้า 404 ที่โผล่ทันทีหลังสร้างสำเร็จ
              */}
            <div style={tileNoteStyle}>
              กดแล้วกลับไปที่จอรายการการ์ด — จอแก้บล็อกทีละอันยังทำไม่เสร็จ
              การ์ดใบนี้จะมีบล็อกของเทมเพลตติดมาให้แล้ว
            </div>
          </Panel.Row>
        </Panel>
      )}
